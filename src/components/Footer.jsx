      ...
      <nav className={styles["bottom-nav"]}>
        <Link to="/home" className={styles.link}>
          <div className={styles["nav-item"]}>
            <div className={`${styles["nav-icon"]} ${styles.home} ${path === '/home' ? styles.active : ''}`} />
            <span className={styles["nav-label"]}>홈</span>
          </div>
        </Link>
        <Link to="/chat" className={styles.link}>
        <div className={styles["nav-item"]}>
          <div className={`${styles["nav-icon"]} ${styles.message} ${path === '/chat' ? styles.active : ''}`} />
        ...
        <div className={styles["nav-item"]}>
          <div className={`${styles["nav-icon"]} ${styles.user} ${path === '/profile' ? styles.active : ''}`} />
